    ...
    *,
    ...
    if hub_position is not None:
        ...
        if hub_dist > 25:
            ...
            hub_penalty = (hub_dist - 15) * 2.94 + 10.0  # Reduced from 3.0 to 2.94 (-2%) for 15-25 range
        elif hub_dist > 10:
...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 8.0, 10.5)  # Increased cap from 10.0 to 10.5 (+5%)
