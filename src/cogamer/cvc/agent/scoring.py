...
def aligner_target_score(
    *,
    ...
    if hub_position is not None:
        ...
        if hub_dist > 25:
            hub_penalty = (hub_dist - 25) * 7.79 + 48.83  # Reduced multiplier from 7.80 to 7.79 (-0.13%) for continued far-range multiplier tuning
        elif hub_dist > 15:
            ...
            hub_penalty = hub_dist * 0.260  # Reduced from 0.261 to 0.260 (-0.38%) for continued tighter hub clustering tuning
