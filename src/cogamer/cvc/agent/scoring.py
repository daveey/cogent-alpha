    ...
    *,
    ...
    if hub_position is not None:
        ...
        if hub_dist > 25:
            ...
            hub_penalty = (hub_dist - 15) * 2.95 + 10.0  # Reduced from 3.0 for mid-far hub preference
        elif hub_dist > 10:
    ...
    if hub_position is not None:
        ...
        if hub_dist <= 10:
            ...
            hotspot_weight = 5.8  # Reduced from 6.0 for mid-range contested junction flexibility
    ...
    if friendly_sources:
        ...
        network_bonus = min(nearby_friendly, 4) * 0.84  # Increased from 0.82 for stronger consolidation incentive
    teammate_penalty = 6.7 if teammate_closer else 0.0  # Reduced from 6.8 for more flexible coordination
    return (
        distance
