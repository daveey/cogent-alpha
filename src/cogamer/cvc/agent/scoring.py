    ...
    *,
    ...
    if hub_position is not None:
        ...
        if hub_dist > 25:
            ...
            hub_penalty = (hub_dist - 10) * 1.46 + 1.96  # Reduced base from 2.0 to 1.96 (-2%) for 10-15 range
        else:
    ...
    return (
        distance
        - min(expansion * 6.2, 36.5)  # Increased cap from 36.0 to 36.5 (+1.4%) for extreme expansion cases
