...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 7.52, 10.88)  # Reduced divisor from 7.54 to 7.52 (-0.27%) for continued faster pressure growth
    ...
    if friendly_junctions:
        ...
        threat_bonus = threatened * 10.58  # Increased from 10.56 to 10.58 (+0.19%) for continued defensive priority tuning
    return (
