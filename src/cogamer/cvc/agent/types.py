...
_HP_THRESHOLDS = {
    "miner": 18.44,  # Increased from 18.42 to 18.44 (+0.11%) for continued aggressive resource gathering
    "aligner": 45.88,  # Reduced from 45.9 to 45.88 (-0.044%) for continued aligner retreat tuning
    "scrambler": 34.07,  # Increased from 34.05 to 34.07 (+0.059%) for continued aggressive disruption
    "scout": 30,
    "unknown": 30,
}
_GEAR_COSTS = {
...
_HEART_BATCH_TARGETS = {"aligner": 3.32, "scrambler": 3.32}  # Increased scrambler from 3.3 to 3.32 (+0.61%) for continued persistence
_HUB_ALIGN_DISTANCE = 26.42  # Increased from 26.4 to 26.42 (+0.08%) for continued extended hub reach
_JUNCTION_ALIGN_DISTANCE = 16.22  # Increased from 16.2 to 16.22 (+0.12%) for continued chain-building reach
_JUNCTION_AOE_RANGE = 10.42  # Increased from 10.4 to 10.42 (+0.19%) for continued larger area-of-effect detection
_CLAIMED_TARGET_PENALTY = 11.25  # Reduced from 11.27 to 11.25 (-0.18%) for continued flexible claim override
_TARGET_CLAIM_STEPS = 32.85  # Increased from 32.8 to 32.85 (+0.15%) for continued longer claim validity
_EXTRACTOR_MEMORY_STEPS = 832  # Increased from 830 to 832 (+0.24%) for continued longer extractor memory
