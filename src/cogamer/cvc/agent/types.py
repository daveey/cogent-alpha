...
_HP_THRESHOLDS = {
    ...
    "aligner": 45.68,  # Increased from 45.66 to 45.68 (+0.044%) for continued aligner retreat tuning
...
_HEART_BATCH_TARGETS = {"aligner": 3.56, "scrambler": 3.56}  # Increased scrambler from 3.54 to 3.56 (+0.57%) for continued scrambler persistence tuning
