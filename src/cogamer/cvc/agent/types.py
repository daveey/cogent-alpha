...
_HP_THRESHOLDS = {
    ...
    "aligner": 47,  # Reduced from 50 (-6%) for safer aligner retreat and better survival
...
_EMERGENCY_RESOURCE_LOW = 2  # Increased from 1 to 2 for slightly earlier emergency mining trigger
