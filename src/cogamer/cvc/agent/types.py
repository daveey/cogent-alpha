...
_HP_THRESHOLDS = {
    "miner": 18.46,  # Increased from 18.44 to 18.46 (+0.11%) for further aggressive resource gathering
    "aligner": 45.86,  # Reduced from 45.88 to 45.86 (-0.044%) for further aligner retreat tuning
...
_HEART_BATCH_TARGETS = {"aligner": 3.36, "scrambler": 3.36}  # Increased scrambler from 3.34 to 3.36 (+0.60%) for further scrambler persistence
_HUB_ALIGN_DISTANCE = 26.46  # Increased from 26.44 to 26.46 (+0.08%) for further extended hub reach
_JUNCTION_ALIGN_DISTANCE = 16.26  # Increased from 16.24 to 16.26 (+0.12%) for further chain-building reach
_JUNCTION_AOE_RANGE = 10.46  # Increased from 10.44 to 10.46 (+0.19%) for further larger area-of-effect detection
_CLAIMED_TARGET_PENALTY = 11.23  # Reduced from 11.25 to 11.23 (-0.18%) for continued flexible claim override
_TARGET_CLAIM_STEPS = 32.9  # Increased from 32.85 to 32.9 (+0.15%) for continued longer claim validity
_EXTRACTOR_MEMORY_STEPS = 834  # Increased from 832 to 834 (+0.24%) for continued longer extractor memory
