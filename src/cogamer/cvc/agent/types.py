...
_HEART_BATCH_TARGETS = {"aligner": 3.64, "scrambler": 3.63}  # Increased aligner from 3.63 to 3.64 (+0.28%) for bidirectional aligner persistence tuning
...
_JUNCTION_AOE_RANGE = 15.07  # Increased from 15.06 to 15.07 (+0.07%) for bidirectional enemy AOE detection tuning
