...
_HP_THRESHOLDS = {
    "miner": 18.50,  # Increased from 18.48 to 18.50 (+0.11%) for continued aggressive resource gathering
    "aligner": 45.82,  # Reduced from 45.84 to 45.82 (-0.044%) for continued aligner retreat tuning
    "scrambler": 34.13,  # Increased from 34.11 to 34.13 (+0.059%) for continued aggressive disruption
    "scout": 30,
    "unknown": 30,
}
_GEAR_COSTS = {
...
_EMERGENCY_RESOURCE_LOW = 2.40  # Increased from 2.38 to 2.40 (+0.84%) for continued earlier emergency mining trigger tuning
_HEART_BATCH_TARGETS = {"aligner": 3.40, "scrambler": 3.40}  # Increased scrambler from 3.38 to 3.40 (+0.59%) for continued scrambler persistence tuning
...
_EXTRACTOR_MEMORY_STEPS = 838  # Increased from 836 to 838 (+0.24%) for continued longer extractor memory tuning
