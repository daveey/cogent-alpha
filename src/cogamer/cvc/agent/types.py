...
_HP_THRESHOLDS = {
    "miner": 18.72,  # Increased from 18.71 to 18.72 (+0.05%) for bidirectional resource gathering tuning
    "aligner": 45.72,  # Increased from 45.71 to 45.72 (+0.02%) for bidirectional aligner retreat tuning
    "scrambler": 34.35,  # Increased from 34.34 to 34.35 (+0.03%) for bidirectional disruption tuning
    "scout": 30,
    "unknown": 30,
}
_GEAR_COSTS = {
...
_EMERGENCY_RESOURCE_LOW = 2.62  # Increased from 2.61 to 2.62 (+0.38%) for bidirectional emergency mining trigger tuning
