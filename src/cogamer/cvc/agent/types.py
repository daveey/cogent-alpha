...
_HP_THRESHOLDS = {
    ...
    "scrambler": 34.05,  # Increased from 34.0 to 34.05 (+0.15%) for continued aggressive disruption
    "scout": 30,
    "unknown": 30,
}
_GEAR_COSTS = {
...
_EMERGENCY_RESOURCE_LOW = 2.32  # Increased from 2.3 to 2.32 (+0.87%) for continued earlier emergency mining trigger
...
_EXTRACTOR_MEMORY_STEPS = 830  # Increased from 820 to 830 (+1.2%) for continued longer extractor memory
